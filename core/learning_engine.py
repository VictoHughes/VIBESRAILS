...
from .learning_profile import (
    avg_brief_for_sessions,
    calc_improvement_rate,
    update_profile,
    upsert_metric,
)
...
class LearningEngine:
    ...
    def _calc_improvement_rate(self, conn: sqlite3.Connection) -> float | None:
        ...
        return calc_improvement_rate(conn)
    ...
    def _avg_brief_for_sessions(
        ...
        return avg_brief_for_sessions(conn, session_ids)
    ...
    def _upsert_metric(
        ...
        upsert_metric(conn, metric_name, metric_value, updated_at)
